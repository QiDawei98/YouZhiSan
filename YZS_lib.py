...
alt_Thet = {
    ...
    ('Pr3+', '1I6'): [-2/99, 4/(11 * 15 * 99), -2/(99 * 21 * 13 * 33)],
    # ('Nd3+', '4F7/2'): [2/189, 1/(21 * 45 * 11), -8 / (27 * 13 * 33 * 7)],
    # ('Nd3+', '4F9/2'): [1/(6 * 18), -1/(42 * 99), 1/(126 * 39 * 33)],
    # ('Nd3+', '4G5/2'): [1/(14 * 42), 13 / (77 * 42), 0],
    # ('Nd3+', '4G7/2'): [26 / (3 * 49 * 225), 13 / (9 * 49 * 121), 8 / (33 * 77 * 27)],
    ...
    ('Tm3+', '3F2'): [(-8/(21*15))*1.636, (2/(7*81))*(-1.859), 0],
    ('Tm3+', '3F3'): [(-1/90), (1/(45*99)), (1/(39*99))],
    ('Tm3+', '3F4'): [(-1/126)*(-1.357), (1/(45*77))*(1.527), (-1/(13*63*99))*(5.945)],
